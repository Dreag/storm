...
/**
 * This class defines a more involved transactional topology than TransactionalGlobalCount. This topology processes a
    ...
    public void finishBatch() {
      for (String key : _counts.keySet()) {
        ...
        if (val == null || !val.txid.equals(_id.getTransactionId())) {
          ...
          System.out.println(key+"@@@"+newVal.txid+"@@@"+Thread.currentThread().getName());
